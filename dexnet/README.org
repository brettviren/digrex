...
- a collection of "ports", each which associate a name, numerical ID and a ~zsock_t*~
- a pipeline of message processors associated with each port and called for each message
